...
import type { ChampEntry } from "../components/ChampionsTab.vue"
import type { FinalEntry } from "../components/AllFinalsTab.vue"
import type { LeagueSeasonEntry } from "../components/LeagueSeasonsTab.vue"
import type { AllTimeRow } from "../components/LeagueAllTimeTab.vue"
import type { HistoryStats } from "../components/StatisticsTab.vue"
import type { TeamStatEntry } from "../components/TeamStatsTab.vue"
    ...
    for (const t of completedSeasons.value) {
      ...
      if (isLeague) {
        ...
        if (playoffFinal?.result) {
          rId =
            (playoffFinal.homeId === wId ? playoffFinal.awayId : playoffFinal.homeId) ?? undefined
        } else {
