export default {
  ...
  players: {
    ...
    deleteAllConfirm: "Delete all players?",
    sortDefault: "Default",
    positions: {
      GK: "Goalkeeper",
      DEF: "Defender",
    ...
    generate: {
      buttonLabel: "Generate Players",
      title: "Generate Players",
      hint: "Fills whichever positions this squad is short of, up to 18 players.",
      team: "Team",
      willAdd: "Will add {count} players:",
      willAddMulti: "Will add {count} players across {teams} teams:",
      squadFull: "This squad is already at full strength.",
      noTeamsBelow: "No team is below this squad size.",
      fillAllTeams: "Fill every understaffed team",
      minSquadSize: "Squads below",
      minSquadSizeHint: "Any team with fewer players than this gets filled.",
      firstNames: "First names",
      lastNames: "Last names",
      namesPlaceholder: "One name per line",
      loadFile: "Load file",
      removeFile: "Remove file",
      fileLoaded: "{file} — {count} names loaded",
      clear: "Delete",
  ...
  settings: {
    ...
    dataManagement: {
      ...
      partialImport: "Imported, but {count} tournament(s) could not be read and were skipped.",
    },
    resetSettings: {
  ...
  tournament: {
    ...
    phases: {
      ...
      links: {
        title: "Connections",
        edit: "Change which places advance",
      ...
      config: {
        ...
        seedMode: "Seeding",
        legs: "Matches per pairing",
        opponents: "Opponents per team",
        pots: "Number of pots",
        balance: "Balance home & away",
        finalLegs: "Final",
        thirdPlace: "Third-place match",
        thirdPlaceLegs: "Third-place legs",
        swissSize: "{matchdays} matchdays",
        qualification: "Qualification",
        qualifiersPerGroup: "Advance per group",
        wildcards: "Wildcards",
        wildcardsHint: "Best of the teams finishing one place below",
        advancing: "{count} teams advance",
      },
      errors: {
        noPhases: "Add at least one phase.",
        noEntry: "One phase must have no incoming connection — that is where the teams enter.",
        multipleEntry: "Only one phase can be the starting phase.",
        cycle: "The connections form a loop.",
        unnamed: "Give this phase a name.",
        knockoutHasOutput: "A knockout cannot send teams onward.",
        noFinal: "Mark one phase as the final.",
        multipleFinal: "Only one phase can be the final.",
        finalNotTerminal: "The final phase cannot send teams onward.",
        edgeRankRange: "Places {from}-{to} do not exist — this phase has {available} teams.",
        rangeOverlap: "Two connections claim the same places.",
        ...
        configMismatch: "This phase's settings do not match its type.",
        danglingEdge: "A connection points at a phase that is gone.",
        selfEdge: "A phase cannot connect to itself.",
      },
      advance: "Advance to {phase}",
      locked: "Finish {phase} to unlock this stage.",
      notStarted: "This phase has not started yet.",
    },
    create: {
      ...
      formats: {
        ...
        custom: "Custom",
        customDesc: "Wire up your own phases — groups, tables and knockouts, in any order",
      },
      swissConfig: {
        phase: "League Phase",
        opponents: "Opponents per team",
  ...
  coach: {
    title: "Manager",
    appoint: "Appoint",
    empty: "No manager. The side plays it straight down the middle.",
    styles: {
      attacking: "Attacking",
      balanced: "Balanced",
      defensive: "Defensive",
    ...
    styleHints: {
      ...
      balanced: "No instruction either way.",
      defensive: "Concedes less, scores less.",
    },
    form: {
      title: "Manager",
      hint: "Formation, style and the manager's own rating all change how this team's matches play out.",
      name: "Name",
      namePlaceholder: "Manager name",
      formation: "Formation",
      formationHint: "The shape the side lines up in.",
      style: "Play style",
    ...
    generate: {
      title: "Generate Managers",
      buttonLabel: "Generate managers",
      hint: "Gives every team a manager, rated near the club's own strength.",
      overwrite: "Replace existing managers",
      willAdd: "Will appoint {count} manager(s)",
      keeping: "{count} kept",
      allCoached: "Every team already has a manager",
      generateBtn: "Generate",
    },
  },
  manager: {
