export default {
  ...
  promotionModal: {
    ...
    finalStandingsTitle: "Final Standings — Season {season}",
    relegated: "Relegated",
    promoted: "Promoted",
    promotedFrom: "Promoted from {name}",
    relegatedNote: "Bottom {count} of {name} will receive the relegated teams.",
    incomingTeamsTitle: "Incoming Teams ({count} slots)",
    incomingTeamsTitleSingle: "Incoming Teams (1 slot)",
    noTeamsToPromote: "No available teams to promote. New season will start with {count} teams.",
    slotLabel: "Slot {count}",
    leaveEmpty: "— Leave empty —",
    startNewSeasonBtn: "Start New Season",
    upBadge: "Up",
    downBadge: "Down",
  },
} as const
