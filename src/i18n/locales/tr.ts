export default {
  ...
  promotionModal: {
    ...
    finalStandingsTitle: "Son Puan Durumu — Sezon {season}",
    relegated: "Düştü",
    promoted: "Yükseldi",
    promotedFrom: "{name} liginden yükseldi",
    relegatedNote: "{name} liginin son {count} sırasındaki takımlar düşen takımları alacaktır.",
    incomingTeamsTitle: "Gelen Takımlar ({count} slot)",
    incomingTeamsTitleSingle: "Gelen Takımlar (1 slot)",
    noTeamsToPromote: "Yükseltilecek uygun takım yok. Yeni sezon {count} takımla başlayacak.",
    slotLabel: "Slot {count}",
    leaveEmpty: "— Boş bırak —",
    startNewSeasonBtn: "Yeni Sezonu Başlat",
    upBadge: "Yukarı",
    downBadge: "Aşağı",
  },
} as const
